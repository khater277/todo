...
class DashboardHead extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String date = DateFormat.d(languageFun(ar: 'ar', en: 'en'))
            .format(DateTime.now()) +
        " " +
        DateFormat.yMMM(languageFun(ar: 'ar', en: 'en')).format(DateTime.now());
    // DateFormatter().dateFormat(DateTime.now().toString())!['date']!;
