...
class SidebarText extends StatelessWidget {
  ...
  final int index;
  const SidebarText(
      {Key? key, required this.text, required this.index, required this.cubit})
      : super(key: key);
            ...
            child: RotatedBox(
              ...
              child: Padding(
                padding: EdgeInsets.symmetric(
                    vertical: languageFun(ar: 2.8.h, en: 3.5.h)),
                child: Text(
                  text,
                  style: Theme.of(context).textTheme.titleLarge!.copyWith(
                        fontSize: languageFun(ar: 14.16.sp, en: 11.66.sp),
                        color: cubit.dashboardTaskIndex == index
                            ? pink
