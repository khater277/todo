            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.only(
                    ...
                    bottomLeft:
                        Radius.circular(languageFun(ar: 0.0, en: 10.0.sp)),
                    topRight:
                        Radius.circular(languageFun(ar: 10.0.sp, en: 0.0)),
                    bottomRight:
                        Radius.circular(languageFun(ar: 10.0.sp, en: 0.0)),
                  )),
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      // final date =
                      //     await context.datePicker(initialDate: DateTime.now());
                      // print("DATE =====> $date");

                      cubit.setWhenColor(context, 2);
                    },
                    child: Container(
                      color: Colors.grey.withOpacity(0.0),
                      child: Center(
                ...
                Expanded(
                  child: cubit.taskDateTime != null
                      ? Text(
                          // '12',
                          languageFun(
                            ar: AppFunctions.replaceArabicNumber(DateFormatter()
                                .dateFormat(
                                    cubit.taskDateTime!.toString())!['date']!),
                            en: DateFormatter().dateFormat(
                                cubit.taskDateTime!.toString())!['date']!,
                          ),
...
class TaskDate extends StatelessWidget {
  final String text;
  final Color color;
  const TaskDate({Key? key, required this.text, required this.color})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding:
          EdgeInsets.symmetric(vertical: languageFun(ar: 3.07.h, en: 3.5.h)),
      child: Text(
        text,
